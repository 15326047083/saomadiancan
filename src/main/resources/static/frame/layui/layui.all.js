...
layui.define(function (e) {
    "use strict";
    var a = document, t = "getElementById", r = "getElementsByTagName", n = "laypage", i = "layui-disabled",
        u = function (e) {
            var a = this;
    ...
    u.prototype.type = function () {
        ...
        if (e) {
            var t = this, n = t.config, i = e.children, u = e[r]("button")[0], p = e[r]("input")[0],
                l = e[r]("select")[0], o = function () {
...
!function () {
    ...
    w.prototype = [], w.prototype.constructor = w, T.extend = function () {
        ...
        var n = this, a = n.config, i = a.dateTime, r = n.lang(),
            ...
            f = "cn" === a.lang, D = f ? "年" : "", w = n.listYM[t] || {}, C = ["hours", "minutes", "seconds"],
            x = ["startTime", "endTime"][t];
        if (w[0] < 1 && (w[0] = 1), "year" === e) {
            var M, b = M = w[0] - 7;
            b < 1 && (b = M = 1), T.each(new Array(15), function (e) {
                var a = T.elem("li", {"lay-ym": M});
                M == w[0] && T(a).addClass(o), a.innerHTML = M + D, d.appendChild(a), n.limit(T(a), {year: M}, t), M++
            }), T(u[f ? 0 : 1]).attr("lay-ym", M - 8 + "-" + w[1]).html(b + D + " - " + (M - 1 + D))
        } else if ("month" === e) T.each(new Array(12), function (e) {
            var a = T.elem("li", {"lay-ym": e});
            e + 1 == w[1] && T(a).addClass(o), a.innerHTML = r.month[e] + (f ? "月" : ""), d.appendChild(a), n.limit(T(a), {
                year: w[0],
                month: e
            }, t)
            ...
            var E = function () {
                T(d).find("ol").each(function (e, a) {
                    T(a).find("li").each(function (a, i) {
                        n.limit(T(i), [{hours: a}, {hours: n[x].hours, minutes: a}, {
                            hours: n[x].hours,
                            minutes: n[x].minutes,
                            seconds: a
            ...
            a.range ? n[x] || (n[x] = {
                ...
                minutes: 0,
                seconds: 0
            }) : n[x] = i, T.each([24, 60, 60], function (e, t) {
        ...
        if (y && h.removeChild(y), h.appendChild(d), "year" === e || "month" === e) T(n.elemMain[t]).addClass("laydate-ym-show"), T(d).find("li").on("click", function () {
            ...
            k(), S.innerHTML = a.range ? [r.startTime, r.endTime][t] : r.timeTips, T(n.elemMain[t]).addClass("laydate-time-show"), H[0] && H.remove(), m[2].appendChild(S), T(d).find("ol").each(function (e) {
                ...
                T(t).find("li").on("click", function () {
                    ...
                    T(this).hasClass(s) || (a.range ? n[x][C[e]] = r : i[C[e]] = r, T(t).find("." + o).removeClass(o), T(this).addClass(o), n.setBtnStatus(null, T.extend({}, n.systemDate(), n.startTime), T.extend({}, n.systemDate(), n.endTime)), E(), k(), (n.endDate || "time" === a.type) && n.done(null, "change"))
                })
            })
        }
        return n
        ...
        T(e.elem).on("click", function (e) {
            ...
            T(n[0]).on("click", function (n) {
                ...
                var a = T(this), i = a.attr("lay-ym").split("-"), r = a.attr("lay-type");
                e.listYM[t] = [0 | i[0], 0 | i[1]], e.list(r, t), T(e.footer).find(v).addClass(s)
...
layui.define("jquery", function (i) {
    ...
    s.prototype.set = function (i) {
        ...
        return n.append('<li lay-id="' + (t.id || "") + '">' + (t.title || "unnaming") + "</li>"), s.append('<div class="layui-tab-item">' + (t.content || "") + "</div>"), y.hideTabMore(!0), y.tabAuto(), this
