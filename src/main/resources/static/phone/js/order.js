...
function getOrder() {
    $.ajax({
        ...
        success(order) {
            ...
            $("#orderAllPrice tbody").append(str4 + order.allPrice / 100 + str5 + "积分抵￥1.00" + str6 + "¥" + (order.allPrice - 100) / 100 + str7);
            ...
            if (order.state == 0) {
                ...
                $("#discussOrPay").append("\n" +
                    ...
                    "        <a href=\"about-us.html\" class=\"userIcon\"><img src=\"/phone/img/index4.png\"/>我的</a>\n" +
                    "    </nav>");
            }
        }
    });
